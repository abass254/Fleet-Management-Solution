                            ...
                            <div class="row">
                                <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h4 class="fw-bolder mb-0">{{$veh}}</h4>
                                            <p class="card-text font-small-3 mb-0">Total Vehicles</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h4 class="fw-bolder mb-0">{{$staff}}</h4>
                                            <p class="card-text font-small-3 mb-0">Total Staff Members</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h4 class="fw-bolder mb-0">{{$trips}}</h4>
                                            <p class="card-text font-small-3 mb-0">Total Trips Made</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-sm-6 col-12">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            ...
                                            <p class="card-text font-small-3 mb-0">Total Equipments</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
